...
if __name__ == "__main__":
    db.connect()
    db.create_tables([Pizza, Bebida, Bebida_Pedida, Cliente, Pedido, Ingrediente, Ingrediente.pedidos.get_through_model(), Pizza_Pedida, Fornada, Tamanho, Endereco])
...
ingrediente1.pedidos.add(pedido1)

print(bebida_pedida1.pedido.cliente.endereco_cliente.rua)
